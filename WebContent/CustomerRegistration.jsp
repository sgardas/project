...
<body class="blank">
  <div><marquee><strong>ILP DTH Services</strong></marquee></div>
        ...
        <div class="col-md-12">
            ...
            <div class="hpanel">
                <div class="panel-body">
                        <form action="Mainservlet?action=aftercustomerreg" method="post" id="loginForm">
                           ...
                           <div class="form-group">
                                <label class="control-label" for="Todaysdate">Today's-date</label>
                                <input type="text" placeholder="Please enter date"  required="" value="" name="creationdate" id="" class="form-control">
                            </div> 
